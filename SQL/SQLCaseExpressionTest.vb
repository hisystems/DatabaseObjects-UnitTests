...
Public Class SQLCaseExpressionTest
    ...
    Public Sub CaseExpressionBasic()
        ...
        Assert.AreEqual("CASE WHEN 1 = 1 THEN 2 END", caseExpression.SQL(Database.ConnectionType.SQLServer))
    ...
    Public Sub CaseExpressionWithInputExpression()
        ...
        Assert.AreEqual("CASE [Field1] WHEN 'Value1' THEN '1' END", caseExpression.SQL(Database.ConnectionType.SQLServer))
    ...
    Public Sub CaseExpressionWithInputExpressionMultipleCasesAndElse()
        ...
        Assert.AreEqual("CASE [Field1] WHEN 'Value1' THEN '1' WHEN 'Value2' THEN '2' ELSE '99' END", caseExpression.SQL(Database.ConnectionType.SQLServer))
    ...
    Public Sub CaseExpressionnNoCases()
        ...
        caseExpression.SQL(Database.ConnectionType.SQLServer)
