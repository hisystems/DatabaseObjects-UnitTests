...
Public Class SQLFunctionExpressionTest
	...
	Public Sub SQLFunctionNoArguments()
		...
		Assert.AreEqual("SQLFunction", function1.SQL(Serializers.Items(Database.ConnectionType.SQLServer)))
	...
	Public Sub SQLFunctionWithNullArgument()
		...
		Assert.AreEqual("SQLFunction(NULL)", function1.SQL(Serializers.Items(Database.ConnectionType.SQLServer)))
	...
	Public Sub SQLFunctionOneArgument()
		...
		Assert.AreEqual("SQLFunction(1)", function1.SQL(Serializers.Items(Database.ConnectionType.SQLServer)))
	...
	Public Sub SQLFunctionMultipleComplexArguments()
		...
		Assert.AreEqual("SQLFunction(1, ([Field1] + 2))", function1.SQL(Serializers.Items(Database.ConnectionType.SQLServer)))
